...
from page_editor.settings import VERSIONS, PLACEHOLDER, SHOW_PLACEHOLDER, FORCE_PLACEHOLDER
from page_editor.base import FileObject
from page_editor.sites import get_default_site
...
class VersionNode(Node):
    ...
    def render(self, context):
        ...
        if isinstance(source, FileObject):
            ...
            source = source
        site = context.get('page_editor_site', get_default_site())
